/**
 * Integration types for Unified Integration Specification
 * These types define the contract between modules and the Electron app
 */
...
export interface ModuleResult {
  ...
  recommendations: any[]; // Use existing Recommendation type
...
export interface ResultSummary {
  ...
  averageRateImprovement?: number; // Rate optimizer
}
...
export interface CalendarEvent {
  ...
  event_id?: string;
  module: 'fscs-compliance' | 'rate-optimizer';
  action_type: 'fscs_breach' | 'rate_optimization' | 'diversification' | 'review';
